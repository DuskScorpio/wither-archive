# Stationary Wither Skull Generator
...
- 1.21.4-1.21.9
## Notes
- Flip the lever so that pistons are spamming
- Press the button on command block to spawn withers
- Quickly show the withers the chicken and immidiately hide it again
